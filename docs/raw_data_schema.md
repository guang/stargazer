...
- `replay_id (simple_matches['replays']['id'])`

  Integer

- `replay_url (simple_matches['replays']['url'])`
...
- `player0_supply_current (extended_matches['SupplyUsage'][player0_id][first column])`

  Integer

- `player0_supply_max (extended_matches['SupplyUsage'][player0_id][second column])`
...
- `player1_vespene_collection_rate (extended_matches['VespeneCollectionRate'][player1_id])`
- `player1_vespene_current (extended_matches['VespeneCurrent'][player1_id])`
- `player1_minerals_collection_rate (extended_matches['MineralsCollectionRate'][player1_id])`
- `player1_minerals_current (extended_matches['MineralsCurrent'][player1_id])`
- `player1_supply_current (extended_matches['SupplyUsage'][player1_id][first column])`
- `player1_supply_max (extended_matches['SupplyUsage'][player1_id][second column])`
- `player1_workers_active_count (extended_matches['WorkersActiveCount'][player1_id])`
- `player1_lost (extended_matches['Lost'][player1_id])`

##### By Frame

- `player1_upgrades (extended_matches['upgrades'][player1_id])`
- `player1_scouting (extended_matches['scouting'][player1_id])`
- `player1_num_bases (extended_matches['num_bases'][1])`
- `player1_armies_by_frame (extended_matches['armies_by_frame'][player1_id])`
- `player1_aggressions (extended_matches['aggressions'][player1_id])`
